  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href=""><i class="fa fa-user-circle-o"></i> <span>Tareas</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ route('tasks.index') }}">Listado de tareas</a></li>
            <li><a href="{{ route('tasks.create') }}">Registrar tarea</a></li>
          </ul>
        </li> 
      </ul>
      <!-- /.sidebar-menu -->
